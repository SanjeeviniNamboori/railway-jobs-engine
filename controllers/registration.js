...
var post_user = {
    ...
    var count =0;
        ...
        for(var i=0;i<ret.length;i++){
            ...
            var profileimagedata = {uid:data.insertId,profileimage:null}
    ...
    connection.query('insert into login set?', login_data,(error5,result5)=>{
       if(result5){ 
           ...
           connection.query('insert into profileimage set?',profileimagedata,(error6,result6)=>{
               if(result6){
               console.log("profileimage data saved successfully");}
           } )
